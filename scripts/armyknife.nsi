...
!define APPNAME "Armyknife"
!define COMPANYNAME "Ducode"
!define DESCRIPTION "A cross-platform console app with lots of handy tools. "
...
section "install"
    ...
    createShortCut "$SMPROGRAMS\${COMPANYNAME}\${APPNAME}.lnk" "$INSTDIR\Armyknife.exe"
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${COMPANYNAME} ${APPNAME}" "DisplayIcon" "$INSTDIR\Armyknife.exe"
